...
Sources of selfstudy i did to keep it all in one place. Doesn't include the video's i've watched.  

1/4" Jack connection to Arduino (blogpost)  
https://forum.arduino.cc/t/trying-to-get-audio-output-from-a-1-4-jack-using-pwm-and-an-rc-filter/1407908  
- Includes code
- Includes solution to problem
- Includes schematics


**things from lesson 1 feeedback:**  
- Bas de Bruin: https://octo.hku.nl/octo/repository/getfile?id=S3l_dTp2RY8
- Beagle/Bela board: https://learn.bela.io/using-bela/about-bela/bela-and-beagleboard/
- Vida sent: https://electro-smith.com/products/daisy-seed?variant=45175761076516

**Daisy Stuff**  
- Setting up C++: https://daisy.audio/tutorials/cpp-dev-env/#3c-more-setup-windows-only  
- Together with video 20  
